...
import { User, Mail, Lock, Phone, ArrowRight, AlertCircle, Building2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md space-y-2 text-center">
        ...
        <p className="text-xs text-slate-500">Apply to 10,000+ jobs, internships & government notices for free</p>
      </div>
