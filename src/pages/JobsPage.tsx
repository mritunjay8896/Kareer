    ...
    <div className="min-h-screen bg-slate-50/60 pb-16 pt-3">
      <div className="w-full max-w-[1536px] 2xl:max-w-[1680px] mx-auto px-4 sm:px-6 lg:px-8 space-y-3 sm:space-y-3.5">
        ...
        <div className="w-full flex flex-col lg:flex-row gap-3.5 lg:gap-4 xl:gap-5 items-start pt-1">
          ...
          <div className="w-full lg:w-[300px] xl:w-[320px] shrink-0 space-y-5 lg:sticky lg:top-20 lg:self-start lg:max-h-[calc(100vh-5.5rem)] lg:overflow-y-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
            
            {/* No Experience Yet / Break The Loop Card */}
            <div 
              id="no-experience-career-card"
              className="bg-white rounded-[22px] p-5 border border-[#DCE8F8] shadow-[0_4px_20px_rgba(21,101,237,0.08)] relative overflow-hidden flex flex-col justify-between"
            >
              ...
              <div className="absolute top-4 right-4 select-none pointer-events-none z-10">
                <div className="relative inline-block text-right">
                  {/* Sparks */}
                  <svg className="w-4 h-4 absolute -left-4 -top-1 text-[#1565ED]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
                    <line x1="12" y1="2" x2="12" y2="7" />
                    <line x1="4" y1="12" x2="8" y2="10" />
                    <line x1="20" y1="7" x2="16" y2="11" />
                  </svg>
                  {/* Handwritten label */}
                  <div className="text-[10px] font-black leading-[1.1] text-[#1565ED] rotate-[4deg] tracking-tight">
                    Your<br />Career<br />Starts<br />Here
                  </div>
                  {/* Curved arrow pointing toward the boy */}
                  <svg className="w-4 h-6 text-[#1565ED] ml-auto mt-0.5" viewBox="0 0 24 28" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className="absolute right-[-4px] bottom-[54px] w-[165px] sm:w-[175px] pointer-events-none z-10 flex items-end justify-end">
                <img
                  src={internBoyImg}
              ...
              {/* Foreground Content: Badges, Heading, Description */}
              <div className="relative z-10 space-y-3 mb-4">
                {/* Top Badges */}
                <div className="flex flex-col items-start gap-1.5">
                  {/* Blue pill: 🚀 BREAK THE LOOP */}
                  <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#1565ED] text-white text-[11px] font-black uppercase tracking-wider shadow-xs">
                    <Rocket className="w-3.5 h-3.5 text-white -rotate-12 stroke-[2.2]" />
                    <span>BREAK THE LOOP</span>
                  </span>
                  {/* Yellowish orange pill: No Experience Yet? */}
                  <span className="inline-flex items-center px-3 py-1 rounded-full bg-amber-100 text-amber-900 border border-amber-200 text-[11.5px] font-bold">
                    No Experience Yet?
                  </span>
                </div>

                {/* Heading */}
                <h3 className="text-[19px] sm:text-[20px] font-black text-[#0F172A] tracking-tight leading-[1.18] font-display max-w-[185px]">
                  Get an Internship to<br />Start Your Career
                </h3>

                {/* Description */}
                <p className="text-[12px] sm:text-[12.5px] text-[#556987] font-normal leading-[1.5] max-w-[170px] sm:max-w-[178px]">
              ...
              <div className="relative z-20 mb-3.5">
                <Link
                  to="/internships"
                  className="w-full h-[42px] bg-[#1565ED] hover:bg-[#0E56D6] text-white font-extrabold rounded-[14px] text-[13px] shadow-[0_8px_20px_rgba(21,101,237,0.32)] hover:shadow-[0_10px_24px_rgba(21,101,237,0.42)] transition-all hover:scale-[1.01] active:scale-[0.98] flex items-center justify-between px-4 group"
                >
              ...
              {/* Footer */}
              <div className="pt-2.5 border-t border-[#E3EDFB] flex items-center text-[12.5px] relative z-10">
