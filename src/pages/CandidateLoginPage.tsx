...
export const CandidateLoginPage: React.FC = () => {
  const { currentUser, userRole, authInitialized, loginCandidate } = useAuth();
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md space-y-2 text-center">
        ...
        <p className="text-xs text-slate-500">Access your job applications, ATS score, and saved vacancies</p>
      </div>
