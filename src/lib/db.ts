...
export const initialJobsList: Omit<JobItem, 'id'>[] = [
  ...
  },
  {
    ...
    companyType: 'Unicorn',
    skills: ['Python', 'SQL', 'Machine Learning', 'Tableau', 'Pandas'],
    postedTime: '1 day ago',
    applicantsCount: 128,
    featured: true,
    description: 'Provide advanced predictive modeling and data solutions to global enterprise clients. Work with deep learning, NLP, and modern LLM frameworks.',
    responsibilities: [
      'Build predictive machine learning pipelines with Python and scikit-learn',
      'Translate business questions into structured analytical models',
      'Deploy models into cloud microservices with FastAPI'
    ],
    requirements: [
      'B.Tech / M.Sc in Computer Science, Statistics, or Data Science',
      'Strong proficiency in Python, SQL, and exploratory data analysis',
  ...
  },
  {
    ...
    applicantsCount: 65,
    description: 'Exciting opportunity for an experienced React developer to join our tier-1 enterprise digital transformation project.',
    responsibilities: [
  ...
  },
  {
    ...
    applicantsCount: 39,
    description: 'Responsible for architecting cloud infrastructure, automating CI/CD pipelines, and maintaining high availability across Kubernetes clusters.',
    responsibilities: [
      'Design, configure and manage cloud infrastructure using Terraform',
      'Manage CI/CD release pipelines via GitHub Actions and ArgoCD',
      'Monitor application metrics, Prometheus alarms, and Grafana dashboards'
    ],
    requirements: [
      'Minimum 2 years experience with AWS/GCP and Docker/Kubernetes',
