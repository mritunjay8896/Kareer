...
export const HeroIllustration: React.FC = () => {
  return (
    <div className="relative w-full flex items-center justify-center lg:justify-end py-0 sm:py-2">
      ...
      <div className="relative w-full max-w-md lg:max-w-[460px] xl:max-w-[520px] group transition-all duration-500">
        <div className="relative w-full overflow-hidden rounded-xl sm:rounded-2xl">
          ...
          />
          {/* Bottom gradient fade for seamless blending on mobile */}
          <div className="absolute inset-x-0 bottom-0 h-16 sm:h-20 lg:h-0 bg-gradient-to-t from-slate-50 via-slate-50/70 to-transparent pointer-events-none z-10" />
        </div>
      </div>
    </div>
  );
