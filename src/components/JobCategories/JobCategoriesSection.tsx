...
import { Code2, Briefcase, Database, Laptop, Landmark, ArrowUpRight } from 'lucide-react';
...
export const MAIN_CATEGORIES: CategoryItem[] = [
  ...
  {
    id: 'govt-psu',
    name: 'Govt & PSU Notifications',
    count: '3.5k+ Positions',
    icon: Landmark,
    colorScheme: {
