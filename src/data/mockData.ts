...
export const MOCK_JOBS: JobItem[] = [
  ...
  {
    id: 'job-8',
    slug: 'technical-support-engineer-concentrix',
    ...
    experience: '0-2 Yrs',
    category: 'IT',
    department: 'Cloud Support & IT',
    roleCategory: 'Support Engineer',
    companyType: 'Foreign MNC',
    education: 'B.E / B.Tech / BCA / Any Graduate',
    industry: 'Cloud Infrastructure & Managed Services',
    skills: ['Linux', 'Networking', 'AWS Basics', 'Troubleshooting'],
    postedTime: '1 day ago',
    applicantsCount: 430,
    description: 'Walk-in interview drive on Saturday for Cloud and Technical support operations.',
    responsibilities: ['Manage technical escalations and server logs troubleshooting.'],
    requirements: ['Good problem-solving and basic networking knowledge.'],
    perks: ['2-Way Cab Transport', 'Shift Allowance', 'Certification Support']
  }
];
...
export const TRENDING_CAROUSEL: TrendingItem[] = [
  ...
  },
  {
    ...
    description: 'Detailed roadmap for non-IT & Mech grads to transition into ₹12+ LPA Tech roles.',
...
export const SUCCESS_STORIES: SuccessStory[] = [
  {
    ...
    previousRole: 'Junior Support Associate (₹2.8 LPA)',
    currentRole: 'SDET Automation Engineer (₹14.5 LPA)',
    company: 'Microsoft India',
    companyLogo: '💻',
    salaryIncrease: '+418% Hike',
    quote: 'CareerPulse guided my roadmap from manual support to Java Selenium automation. The ATS resume checker got me my first callback within 3 days!',
...
export const CAREER_SWITCH_PATHS: CareerSwitchPath[] = [
  {
    id: 'cs-1',
    title: 'Manual QA / Support → SDET Lead',
    fromRole: 'Manual QA / Support',
    avgSalary: '₹12 - ₹22 LPA',
    demandGrowth: '+38% YoY',
    duration: '4 - 6 Months',
    steps: [
      { role: 'Support Specialist', timeline: 'Start', skills: ['Communication', 'Process Knowledge'] },
...
export const SEO_CATEGORIES: SEOCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Cloud & DevOps Jobs', url: '/jobs/cloud-devops' },
